...
using CommandVisitor = void (*)(const CmdInfo& info, void* userdata);
void forEachCommand(CommandVisitor visitor, void* userdata = nullptr);
size_t registeredCommandCount();
