...
public:
    ...
    // move
    unordered_multiset(unordered_multiset&& other) noexcept : table_() { table_.swap(other.table_); }
    unordered_multiset& operator=(unordered_multiset&& other) noexcept { table_.swap(other.table_); return *this; }
