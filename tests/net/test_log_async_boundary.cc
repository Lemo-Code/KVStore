...
int main() {
  ...
  {
    const std::string base = net_test::LogPath("async_boundary_time");
  ...
  {
    const std::string ring_base = net_test::LogPath("async_boundary_ring");
    ...
    logger->addAppender(net::LogAppender::ptr(new net::CircularFileLogAppender(
        ring_base, 3, 9, {ring0, ring1, ring2})));
  ...
  {
    const std::string roll_path = net_test::LogPath("async_boundary_roll.log");
    auto logger =
    ...
    logger->addAppender(net::LogAppender::ptr(new net::RollingFileLogAppender(
        roll_path, 12, 4, net::file_sink::RollInterval::NONE)));
    ...
    const std::string rolled = ReadFile(roll_path + ".1") + ReadFile(roll_path + ".2") +
                               ReadFile(roll_path + ".3") + ReadFile(roll_path + ".4");
