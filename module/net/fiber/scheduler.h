#ifndef NET_FIBER_SCHEDULER_H
#define NET_FIBER_SCHEDULER_H

#include "fiber/fiber.h"
#include "fiber/run_queue.h"
...
class SchedulerSwitcher : Noncopyable {
 public:
