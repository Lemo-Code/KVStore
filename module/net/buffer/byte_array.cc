...
bool ByteArray::isLittleEndian() const { return endian_ == NET_LITTLE_ENDIAN; }

void ByteArray::setIsLittleEndian(bool val) {
  endian_ = val ? NET_LITTLE_ENDIAN : NET_BIG_ENDIAN;
}
