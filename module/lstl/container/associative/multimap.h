#ifndef LSTL_MULTIMAP_H
#define LSTL_MULTIMAP_H
...
class multimap {
 ...
 public:
  ...
  multimap(multimap&& other) throw() : tree_(lstl::move(other.tree_)) {}
  ...
  multimap& operator=(multimap&& other) throw() {
  ...
  iterator insert(const Pair& x) {
    return tree_.insert_equal(value_type(x.first, x.second));
  }
  ...
  void swap(multimap& other) { tree_.swap(other.tree_); }
};

template <typename Key, typename T, typename Compare, typename Alloc>
inline bool operator==(const multimap<Key, T, Compare, Alloc>& a,
...
template <typename Key, typename T, typename Compare, typename Alloc>
inline void swap(multimap<Key, T, Compare, Alloc>& a, multimap<Key, T, Compare, Alloc>& b) {
  a.swap(b);
}

}  // namespace lstl

#endif  // LSTL_MULTIMAP_H
