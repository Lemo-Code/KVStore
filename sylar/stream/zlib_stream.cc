...
//不支持
int ZlibStream::read(Ringbuffer::ptr rb, size_t length) {
    throw std::logic_error("ZlibStream::read is invalid");
}

int ZlibStream::write(Ringbuffer::ptr rb, size_t length) {
    throw std::logic_error("ZlibStream::write is invalid");
}

sylar::Ringbuffer::ptr ZlibStream::getRingbuffer() {
    throw std::logic_error("ZlibStream::getRingbuffer is invalid");
}
