#ifndef __SYLAR_RINGBUFFER_H__
#define __SYLAR_RINGBUFFER_H__
...
class Ringbuffer : public Noncopyable
{
  ...
  {
    int64_t be64 = byteswapOnLittleEndian(x);
  ...
  {
    int32_t be32 = byteswapOnLittleEndian(x);
    append(&be32, sizeof be32);
  }

  void appendInt16(int16_t x)
  {
    int16_t be16 = byteswapOnLittleEndian(x);
  ...
  int64_t peekInt64() const
  {
    ...
    return byteswapOnLittleEndian(be64);
  }
  ...
  int16_t peekInt16() const
  {
    ...
    return byteswapOnLittleEndian(be16);
  }
